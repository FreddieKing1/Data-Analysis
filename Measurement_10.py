# -*- coding: utf-8 -*-
"""
Created on Thu Feb  3 11:54:35 2022
...
myvideo=cv2.VideoCapture('C:/Users/Freddie/Data/Measure_10.mp4')
numberframes=0
...
fit,cov=curve_fit(sin,time,displacement,p0=[-500,7,0,600],sigma=weights)
...
ang_u=(1/(np.sqrt(abs(1-angle**2))))*np.sqrt(((a/l)*np.sqrt(cov[0][0]))**2+((fit[0]/l)*a_u)**2+(((fit[0]*a)/(l**2))*l_u)**2)
